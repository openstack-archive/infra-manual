...
the same. If you add a Depends-On for the backported change, it now is
also dependent on the backported change. This might be desirable for
some changes and a surprise for others.
