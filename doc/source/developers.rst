...
To get early response on a change which is not fully finished yet,
...
After uploading new patchset, this -1 (WIP) vote disappears.
So if You still plan to do additional changes, don't forget to set it again.
