...
We have a tutorial on `how to work with our sandbox repository`_.
If this is your first time contributing to OpenStack we strongly
suggest you follow this tutorial.

.. _how to work with our sandbox repository: content/sandbox.html
