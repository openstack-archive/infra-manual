...
the status of the jobs which were run. Once all of the jobs
report success in the configured merge pipeline, then
Jenkins will merge the code into the trunk.
