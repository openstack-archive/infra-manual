...
For that look at the diff of changes done in file (click the file name),
...
the Review message (see above, with or without text and vote), until that
the inline comments are stored as Drafts,
just in your browser and other people can't see them yet.
