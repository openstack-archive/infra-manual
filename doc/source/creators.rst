...
If you configured tests for the project when it was created, ensure
that all of the tests pass successfully before importing. Otherwise
your first patch needs to fix all test failures. You can run most of
the tests locally using ``tox`` to verify that they pass.
