...
While deletion of tags can be done at the source and replicated to the
git mirrors, they are not deplicated to existing git pulls of the repo.
This means anyone who has done a remote update, including systems in the
OpenStack infrastructure which fire on tags, will have that tag
indefinitely.
