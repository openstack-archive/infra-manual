...
practice here is to do it as follows:
...
If you use the same set of repositories several times, introduce a new
template.
...
``stable/juno``, ``stable/kilo`` or ``stable/liberty`` branches.
