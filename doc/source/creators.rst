...
Setting up a Repository without cookiecutter
============================================

If the new project you have added has a specified upstream or if you
want to setup one without using cookiecutter, you will need to add a
``.gitreview`` file to the project once it has been created. This new
