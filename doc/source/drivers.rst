...
keep up to date with changes over time. Then when development on the
feature branch is complete it will need to be merged into master.

Before this can happen the project's milestone group will need to have
access to push merge commits in Gerrit::

  [access "refs/for/refs/*"]
  pushMerge = group <project>-milestone
