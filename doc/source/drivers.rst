...
Many projects have repositories entitled <project>-spec. If a project has a spec repo, a spec will need to be submitted and linked to the launchpad blueprint. The spec will need to be reviewed and approved prior to the launchpad blueprint being targetted to a milestone.
