...
Step 1: Stop requirements syncing
---------------------------------

Submit a review to the requirements project removing the project from
``projects.txt``.  This needs to happen for stable branches as well.
